...
class CompleteLogger:
    ...
    def __init__(self, root, phase='train'):
        self.root = root
        self.phase = phase
        self.visualize_directory = os.path.join(self.root.replace('logs', 'output_viz'), "visualize")
        ...
        hname = os.uname()
        if 'kruskal' in hname.nodename:
            self.checkpoint_directory = os.path.join(self.root.replace('logs', 'checkpoints_yoda'), "checkpoints")
        else:
            self.checkpoint_directory = os.path.join(self.root.replace('logs', 'checkpoints'), "checkpoints")
        ...
        print(self.visualize_directory)
        print(self.checkpoint_directory)
        print(log_filename)

        self.write(self.visualize_directory)
        self.write(self.checkpoint_directory)
        self.write(log_filename)
